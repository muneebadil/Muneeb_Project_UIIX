...
export default function Whitediv() {
  return (
    <div className="w-full h-auto mt-[100px] bg-grey-300"> {/* Removed absolute positioning and added margin-top */}
      <div className="w-full max-w-[1440px] flex flex-col lg:flex-row gap-[30px] px-4 lg:px-0 mx-auto">
        {/* Image Section */}
        <div className="relative w-full lg:w-[707px] h-[400px] lg:h-[682px] flex justify-center">
          <Image
            src="/hero-cover-1.png" // Path relative to the 'public' directory
            alt="couple"
            className="object-contain"
            width={1440} // Specify the width for the image
            height={682} // Specify the height for the image
          />
        </div>
